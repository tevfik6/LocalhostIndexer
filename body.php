...
<div class="list-group main-container">
	<li class="list-group-item list-group-header">
		<span class="file_folder_name">
			<a href="#" v-on="click: sortBy('name', $event)">File/Folder Name <i v-if="sortKeyActive('name')" v-class="fa-sort-alpha-asc: !reverse, fa-sort-alpha-desc: reverse" class="fa "></i></a>
		</span>
		<div class="file_folder_info pull-right">
			<span class="sugar" v-if="anySugarInstances()">
				<span class="version">
					<a href="#" v-on="click: sortBy('sugar_sort_version', $event)">Sugar Version <i v-if="sortKeyActive('sugar_sort_version')" v-class="fa-sort-numeric-asc: !reverse, fa-sort-numeric-desc: reverse" class="fa "></i></a>
				</span>
				<span class="flavor">Sugar Edition</span>
				<span class="build">Sugar Build</span>
			</span>
			<span class="file_folder_size">
				<a href="#" v-on="click: sortBy('size.plain', $event)">File Size <i v-if="sortKeyActive('size.plain')" v-class="fa-sort-numeric-asc: !reverse, fa-sort-numeric-desc: reverse" class="fa "></i></a>
			</span>
			<span class="file_folder_perm">
				<a href="#" v-on="click: sortBy('perm.plain', $event)">Perm  <i v-if="sortKeyActive('perm.plain')" v-class="fa-sort-numeric-asc: !reverse, fa-sort-numeric-desc: reverse" class="fa "></i></a>
			</span>
			<span class="file_folder_mtime">
				<a href="#" v-on="click: sortBy('mtime.plain', $event)">Last Modified  <i v-if="sortKeyActive('mtime.plain')" v-class="fa-sort-amount-asc: !reverse, fa-sort-amount-desc: reverse" class="fa "></i></a>
			</span>
		</div>
	</li>
