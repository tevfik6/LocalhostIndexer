...
<script type="text/javascript">
	var ace_editor_theme = <?php echo !$ace_editor_theme ?: '"'.$ace_editor_theme.'"'?>;
	var ace_editor_mode = <?php echo !$ace_editor_mode ?: '"'.$ace_editor_mode.'"' ?>;
</script>
<div class="main-container">
	<div class="editor-nav">
		<div class="form-inline pull-right">
			<button type="button" class="btn btn-sm btn-default">Soft Wrap</button>
...
<script type="text/javascript">
	...
	if (ace_editor_theme !== false ) editor.setTheme(ace_editor_theme);
